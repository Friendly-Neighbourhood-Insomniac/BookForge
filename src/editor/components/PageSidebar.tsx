...
import { Plus, FileText, Cog, Trash2, Edit2, X } from 'lucide-react';
...
const PageSidebar: React.FC<PageSidebarProps> = ({ isOpen = true, onClose }) => {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <div className="hidden lg:block w-64 bg-cracked-porcelain/95 backdrop-blur-md border-r-2 border-brass/30 relative overflow-y-auto">
        {/* Background effects */}
      ...
      {/* Mobile drawer */}
      <div className={`lg:hidden fixed inset-y-0 left-0 z-40 w-80 bg-cracked-porcelain/95 backdrop-blur-md border-r-2 border-brass/30 transform transition-transform duration-300 ease-in-out ${
